...
async function callIdmVton(
  ...
  const result = await client.predict("/tryon", {
    ...
    is_checked: true,
    is_checked_crop: true, // auto-align person crop for a better, non-squished fit
    denoise_steps: 40,     // higher quality diffusion pass
    seed: 42,
  });
...
export const Route = (createFileRoute("/api/public/tryon") as any)({
  server: {
    handlers: {
