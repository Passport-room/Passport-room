...
window.__updateToolButtons = function () {
  if (typeof window.__updateEnhanceBtn === "function")
    window.__updateEnhanceBtn();
  if (typeof window.__updateTryOnBtn === "function") window.__updateTryOnBtn();
};
